...
<!-- <div class="form-group">
      <label for="pwd">Category :</label> <br>
		@foreach ($CategoryName as $Category)
	    	<p>the Category is:  {{ $Category-> CategoryName }}</p>
		@endforeach  
    </div>
    		...
    		echo $CategoryName[$i]->CategoryName;
		     	...
		     	<div class="col-sm-4" >
		     		...
		     		@for ($i = 0; $i < count($CategoryName); $i += 3)
					    ...
					    <input type="checkbox" value="{{ $CategoryName[$i]->CategoryName }}" name="CatagoryName[]"> {{ $CategoryName[$i]->CategoryName }} <br>
			    ...
			    <div class="col-sm-4" >
					...
					@endfor
			     	<!-- <input type="checkbox"  value="Novel" name="CatagoryName[]"> Novel <br>
			    	<input type="checkbox"  value="Poem" name="CatagoryName[]"> Poem <br>
			     -->
			   	</div>
